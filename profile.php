...
<!-- <h1><//?= basename($_SERVER['PHP_SELF']); ?></h1>  showing profile.php-->
<div class="container">
                        ...
                        <div class="tab-pane container fade" id="changePass">
                            ...
                            <div class="card-deck">
                                ...
                                <div class="card border-success align-self-center">
                                    <img src="assets/img/reset.jpg" class="img-thumbnail img-fluid" width="408px">
                                </div>
    ...
    $(document).ready(function() {
        ...
        $('#profile-update-form').submit(function(e) {
            ...
            $.ajax({
                ...
                contentType: false,
                cache: false,
                data: new FormData(this), // With FormData class we can send img details to the server
                success: function(response) {
                    // console.log(response); // all properties of image [name] => randomName.jpg  [type] => image/jpeg  [error]  => 0 [size] => 68570
                    location.reload();
                }
            });
        });
