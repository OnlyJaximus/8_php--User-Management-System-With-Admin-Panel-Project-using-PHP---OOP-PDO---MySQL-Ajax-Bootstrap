...
<div class="row">
    <!-- <h1><//?= basename($_SERVER['PHP_SELF']) ?></h1> //admin-users.php -->
    <div class="col-lg-12">
...
<!-- Display User's in Details Modal  showUserDetailsModal is in admin-action.php -->
...
<script>
    $(document).ready(function() {
        ...
        // userDetailsIcon from admin-action.php class 4 a tag
        $("body").on("click", ".userDetailsIcon", function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (data.photo != '') {
                        $("#getImage").html('<img src="../assets/php/' + data.photo + '" class="img-thumbnail img-fluid align-self-center" widht="280px">');
                    } else {
                        $("#getImage").html('<img src="../assets/img/avatar.jpg" class="img-thumbnail img-fluid align-self-center" widht="280px">');
                    }
                }
            });
        });
        ...
        // deleteUserIcon class from a tag in admin-action.php
