...
<div class="row">
    <!-- <h1><//?= basename($_SERVER['PHP_SELF']) ?></h1> //admin-dashboard.php -->
    <div class="col-lg-12">
        <div class="card-deck mt-3 text-light text-center font-weight-bold">
            ...
            <div class="card bg-primary">
                ...
                <div class="card-body">
                    <h1 class="display-4"><?= $count->total_count('users'); ?></h1>
                </div>
            </div>
            ...
            <div class="card bg-danger">
                ...
                <div class="card-body">
                    <h1 class="display-4"><?php $data = $count->site_hits();
                                            echo $data['hits']; ?></h1>
                </div>
            </div>
        </div>
